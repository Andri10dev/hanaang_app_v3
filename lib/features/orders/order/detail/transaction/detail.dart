...
import 'package:hanaang_app/features/orders/order/detail/transaction/print.dart';
...
class OrderTransactionDetail extends ConsumerWidget {
  final OrderTransactionModel data;
  const OrderTransactionDetail({super.key, required this.data});
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                children: [
                  _buildRow("Admin", data.admin.name, bold: true),
                  const Divider(),
                  _buildRow("No Pesanan", data.orderNumber),
            ...
            Container(
                ...
                child: TextH2(
                    text: "Pembayaran Pesanan", fontWeight: FontWeight.bold)),
            const Divider(),
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 10),
              child: Column(
                children: [
                  _buildRow("Metode Pembayaran", data.paymentMethod),
                  _buildRow("Total Tagihan", formatCurrency(data.totalPayment)),
                  _buildRow("Nominal Pembayaran", formatCurrency(data.nominal)),
                  const Divider(),
                  _buildRow(
                      "Sisa Tagihan", formatCurrency(data.remainingPayment)),
                ],
              ),
            ),
            SizedBox(
            ...
            Container(
                ...
                child: TextH2(
                    text: "Pengambilan Pesanan", fontWeight: FontWeight.bold)),
            const Divider(),
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 10),
              child: Column(
                children: [
                  ...
                  _buildRow("Jumlah Pengambilan", "${data.totalTaken} Cup"),
                  const Divider(),
