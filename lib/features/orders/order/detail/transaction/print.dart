...
class PrintSample extends StatefulWidget {
  final OrderTransactionModel data;
  const PrintSample({super.key, required this.data});

  @override
  State<PrintSample> createState() => _PrintSampleState();
}

class _PrintSampleState extends State<PrintSample> {
      ...
      child: Material(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildHeader("Transaksi Pesanan", alignment: Alignment.center),
            ...
            _buildRow(
                "Total Tagihan", formatCurrency(data.totalPayment).toString()),
            _buildRow(
                "Total Pembayaran", formatCurrency(data.nominal).toString()),
            _buildDivider(),
            _buildRow("Sisa Tagihan", formatCurrency(data.remainingPayment)),
            SizedBox(height: sHeight),
            _buildHeader("Pengambilan Pesanan :"),
